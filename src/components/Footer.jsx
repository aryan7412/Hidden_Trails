  ...
  return (
    <div className='bg-gray-800 py-8 text-white'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div>
                <h2 className='text-2xl font-bold mb-4'>Hidden Trails</h2>
                <p className='mb-4'>A local guide in your pocket, making every trip unforgettable </p>
            </div>
            ...
            <div>
                ...
                <form className='flex items-center justify-center mt-8'>
                    <input
                        ...
                        className='w-full p-2 rounded-l-lg bg-gray-600'
                    />
                    <button
                    type='Submit'
                    className='bg-blue-600 text-white px-4 py-2 rounded-r-lg border-blue-600'>Subscribe</button>
                </form>
            </div>
        </div>
        <div className='flex justify-between mt-8 border-t border-gray-700 pt-4'>
            <p> © 2024 Hidden Trails. All rights reserved.</p>
